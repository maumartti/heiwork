<template>
	<div>
		<div class="col-lg-12 grid-margin stretch-card p-0">
	      <div class="card">
	        <div class="card-body">                        
	          <h4 class="card-title">Continentes Agregados</h4>
		          ...
		          <table class="table">
		            ...
		            <tbody>
		              <tr v-for="company in companys">
		              	<td>
		              		<img v-if="company.image != null && company.image != 'null'" class="rounded-circle img-lg" :src="'/images/continents/'+company.image">
			  ...
			  <div class="modal-dialog modal-lg" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-header">
			        <h4 class="modal-title text-warning" id="exampleModalLongTitle">Editar Continente <i class="mdi mdi-pencil"></i></h4>
			      ...
			      <div class="modal-body">
			      	<div class="form-row">
			              ...
			              <div class="card">
			                <div class="card-body">
			                  <label>Logo</label>
			                 <slim-cropper :options="slimOptions" :key="componentSlimEdit" :initialimage="'../../../images/continents/'+companySelectEdit.image" id="slim1" >
			...
			<div class="modal fade bd-example-modal-lg" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			  <div class="modal-dialog modal-lg" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-header">
			        <h4 class="modal-title text-success" id="exampleModalLongTitle">Agregar Continente <i class="mdi mdi-plus"></i></h4>
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			          <span aria-hidden="true">&times;</span>
			        </button>
			      </div>
	...
	export default {
		...
		methods:{
		    ...
		    setPlace(place) {
              ...
              this.address_map = '';
              this.address_map += place.address_components[0].long_name;
			...
			editCompany: function(){
				...
				axios.put('/AppContinent/'+this.companySelectEdit.id,this.companySelectEdit).then(response =>{
			...
			companyDelete: function(id){
				if(confirm("¿seguro de eliminar esta empresa?")){
					axios.delete('/AppContinent/'+id).then(response =>{
