...
gulp.task('injectAssets', function () {
  return gulp.src('./**/*.html')
    .pipe(inject(gulp.src([
        ...
        './vendors/puse-icons-feather/feather.css',
...
gulp.task('copyAddonsScripts', function() {
    ...
    var aScript71 = gulp.src(['node_modules/icheck/skins/**/*'])
        .pipe(gulp.dest('./vendors/icheck/skins'));
    var aScript72 = gulp.src(['node_modules/icheck/icheck.min.js'])
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle54 = gulp.src(['node_modules/pwstabs/assets/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
    var aStyle55 = gulp.src(['node_modules/puse-icons-feather/**/*'])
        .pipe(gulp.dest('./vendors/puse-icons-feather'));
    var aStyle56 = gulp.src(['node_modules/owl-carousel-2/assets/owl.video.play.png'])
        .pipe(gulp.dest('./vendors/owl-carousel-2'));
    return merge(aStyle1, aStyle2, aStyle3, aStyle4, aStyle5, aStyle6, aStyle7, aStyle8, aStyle9, aStyle10, aStyle11, aStyle12, aStyle13, aStyle14, aStyle15, aStyle16, aStyle17, aStyle18, aStyle19, aStyle20, aStyle21, aStyle22, aStyle23, aStyle24, aStyle25, aStyle26, aStyle27, aStyle28, aStyle29, aStyle30, aStyle31, aStyle32, aStyle33, aStyle34, aStyle35, aStyle36, aStyle37, aStyle38, aStyle39, aStyle40, aStyle41, aStyle42, aStyle43, aStyle44, aStyle45, aStyle46, aStyle47, aStyle48, aStyle49, aStyle50, aStyle51, aStyle52, aStyle53, aStyle54, aStyle55, aStyle56);
});
